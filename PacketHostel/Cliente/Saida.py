...
class DarSaida:
    def __init__(self):
        ...
        self.BotaoBuscar= Button(self.containerMaster)
        self.BotaoBuscar.configure(text='''VOLTAR ''')
        self.BotaoBuscar.configure(font=self.fonte)
        self.BotaoBuscar.place(relx=0.5, rely=0.9, width=100)
        self.BotaoBuscar.configure(command= root.destroy)
